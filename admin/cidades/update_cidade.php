...
<hr />
  ...
  <div class="container">
    ...
    <main class="container text-center">
      ...
      <form action="update_cidade.php?id=<?php echo $cidade['id']; ?>" id="formAlterarCidade" method="post" class="needs-validation" novalidate>
        <div class="container">
          <div class="col-md-12">
            <div class="form-row justify-content-center align-items-center">
              <div class="form-group col-md-4">
                <label for="inputNome">Nome</label>
                <input type="text" class="form-control" id="inputNome" name="nome" value="<?php echo $cidade['nome']; ?>" required>
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="inputAbreviatura" name="abreviatura" value="<?php echo $cidade['abreviatura']; ?>">
              </div>
            </div>
          </div>
          <div class="container">
