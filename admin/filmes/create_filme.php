          ...
          <div class="col-md-12">
            <div class="form-row justify-content-center align-items-center">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="inputTituloT" name="titulo_traduzido" required>
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="inputTituloO" name="titulo_original">
              </div>
            </div>
            <div class="form-row justify-content-center align-items-center">
              <div class="form-group col-md-1.2">
                <label for="inputDuracao">Duração</label>
                <input type="text" class="form-control" id="inputDuracao" name="duracao">
                </div>
            </div>
            <div class="form-row justify-content-center align-items-center">
            <div class="form-group col-md-3">
                <label for="inputValor">Valor da locação</label>
                <input type="text" class="form-control" id="inputValor" name="valor_locacao">
                </div>
            </div>
          </div>
          <div class="container">
