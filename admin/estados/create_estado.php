...
<header id="custom-header">
  ...
  <div class="container">
    ...
    <main class="container text-center">
      ...
      <form action="create_estado.php" id="formCadastroServico" method="post" class="needs-validation" novalidate>
        <div class="container">
          <div class="col-md-12">
            <div class="form-row justify-content-center align-items-center">
              ...
              <div class="form-group col-md-2">
                <label for="inputValor">Sigla</label>
          ...
          <div class="col-md-12">
            <div class="form-row justify-content-center align-items-center">
              <div class="form-group col-md-4">
                <label for="inputNome">Região</label>
                <input type="text" class="form-control" id="inputRegiao" name="regiao" required>
                <div class="valid-tooltip">
                  Looks good!
                </div>
              </div>
